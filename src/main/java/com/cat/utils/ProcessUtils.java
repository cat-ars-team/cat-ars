...
public class ProcessUtils {
	 ...
	 * @throws Exception
	 */
	public static ActivityImpl getProcessMap(String processdefId, String executionId) throws Exception {
		// 仓库服务
		...
		for (ActivityImpl impl : list) {
			...
			if (id.equals(activityId)) {// 获取执行到那个节点
	 ...
	 * @return
	 */
	public static InputStream findProcessImg(String processDefId) throws Exception {
		// 仓库服务
		RepositoryService repositoryService = getProcessEngine().getRepositoryService();
		// 流程定义信息
