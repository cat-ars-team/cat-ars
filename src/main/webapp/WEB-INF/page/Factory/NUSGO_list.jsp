...
<script type="text/javascript">
		...
		$(function(){
			 $("#subadd").click(function() {
					...
					document.forms["addForm"].action="FactoryNusgo/addppp.do";
					document.forms["addForm"].submit();
			 });
			 		 
			 // 注册 批准 
			 $("#submitApprove").click(function() {   
						document.forms["approveModal"].action="<%=basePath%>FactoryNusgo/update.do";
...
<div class="modal fade" id="approveModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<form action="<%=basePath%>FactoryNusgo/update.do" method="post" enctype="multipart/form-data">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
...
<form action="<%=basePath%>FactoryNusgo/list.do" method="post" class="form-horizontal"  data-validator-option="{theme:'yellow_right_effect',stopOnError:true}">
  ...
  updatetime,updateby,custState,factId,totalcust,appreim -->
							...
							<td>
								<c:if test="${everypro.eventproposal==0 }">
									&nbsp
									 Not Submit
								  	&nbsp
								  		<a href="<%=basePath%>FactoryNusgo/EventProposalLoad.do?proid=${everypro.proid }"   >Submit</a>
									&nbsp 
								</c:if>
		...
		<div align="right" style="margin: 15px;">
			<pg:pager items="${total }" url="FactoryNusgo/list.do" maxIndexPages="3" export="currentPageNumber=pageNumber" scope="request">			
