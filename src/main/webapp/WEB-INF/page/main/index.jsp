...
<body>
		...
		<center>
			<div class="row" style="padding:5px" >			
				<iframe id="mainframe" name="mainframe" src="xtgg.do" 
					style="width: 94%; border: 0px;" scrolling="no" onload="changeFrameHeight()" 
		...
		<script type="text/javascript">
				...
				function changeFrameHeight(){
					 ...
					 var ptHg= document.documentElement.clientHeight;
					 iframe.height=iframe.contentWindow.document.documentElement.scrollHeight;
				        if(iframe.attachEvent){
				            iframe.attachEvent("onload", function(){
				            	var scrollHg= iframe.contentWindow.document.documentElement.scrollHeight;
				            	var ptHg= document.documentElement.clientHeight;
				            	if (scrollHg>ptHg) {
				            		 	iframe.height =  scrollHg;
				            		}else{
				            			iframe.height =  ptHg;
				            		}
				            });
				            ...
				            iframe.onload = function(){
				            	...
				            	var scrollHg= iframe.contentDocument.body.scrollHeight;
				            	var ptHg= document.documentElement.clientHeight;
				            	if (scrollHg>ptHg) {
				            		 	iframe.height =  scrollHg;
				            		}else{
