...
<body>
	...
	<form action="<%=basePath%>Nusgo/EventProposal.do" name="EventForm" id="EventForm" method="post" class="form-horizontal" enctype="multipart/form-data">
		...
		<hr>
			<div class="modal-footer">
				...
				<a  style="background-color:#424040; color:white;font-weight:600;border:2px solid #393838" href="<%=basePath%>Nusgo/list.do" class="btn btn-sm btn-info">Cancel</a>
				</center>
			</div>
