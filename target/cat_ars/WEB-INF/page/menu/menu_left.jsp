<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.*,com.cat.bean.MenuInfo"%>
<%
...
<div>
	<script type="text/javascript">
		...
		%>
		d.add(<%=menu.getMenuId()%>,<%=menu.getPrentMenuId()%>,"（<%=menu.getMenuId()%>）<%=menu.getMenuName()%>","menu/menumain.do?menuId=<%=menu.getMenuId()%>","","rightframe");
		<%}}%>
		document.write(d);
	</script>
