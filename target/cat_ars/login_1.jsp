...
<body class="login-layout">
	<div class="main-container">
		<div class="main-content">
			<div class="row">
						<div class="center">
						<!-- style="background:url(res/img/body-bg.jpg)  -->
							<h1>
								<i class="icon-sitemap green"></i> 
								<span class="white">欢迎使用</span>  
								<span class="red">Cat&reg; (卡特)</span> 
								<span class="white">代理商报销平台</span>
							</h1>
										 
							<h4 class="blue">&nbsp</h4>
						</div>
				...
				<div class="center" style="margin-top:300px">
						<span class="white"> 
							*如您在使用平台中遇到任何问题，可发邮件至<a> eddy.jin@bintang.com.cn </a>，也可致电 <a>010-57077020</a> <br />
